...
PRE_PET_NGS <- PRE_PET %>% 
  ...
  mutate(EF_G_PRE = exp(0.00558*GROW_PRE-7.701),             # determine ratio factor
          EF_NG_PRE = exp(0.00558*NGROW_PRE-7.701),
          EF_G_PET = exp(0.00558*NGROW_PET-7.701),
          EF_NG_PET = exp(0.00558*NGROW_PET-7.701),
          RF_G = EF_G_PET/EF_G_PRE,
          RF_NG = EF_NG_PET/EF_G_PRE) %>%
